...
htmlhelp_basename = 'LAtoolsGUIdoc'
...
latex_documents = [
    (master_doc, 'LAtoolsGUI.tex', 'LAtools GUI Documentation',
     'various', 'manual'),
]
...
man_pages = [
    (master_doc, 'latoolsgui', 'LAtools GUI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LAtoolsGUI', 'LAtools GUI Documentation',
     author, 'LAtoolsGUI', 'One line description of project.',
     'Miscellaneous'),
]
